...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_PathDisplay.setContextMenuPolicy(QtCore.Qt.ActionsContextMenu)
        self.graphicsView_PathDisplay.setAutoFillBackground(True)
        self.graphicsView_PathDisplay.setTransformationAnchor(QtWidgets.QGraphicsView.AnchorViewCenter)
